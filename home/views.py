...
class PostDetailView(View):
    ...
    def setup(self, request, *args, **kwargs):
        ...
        return super().setup(self, *args, **kwargs)
    def get(self, request, *args, **kwargs):
        comments=self.post_instance.pcomments.filter(is_reply=False)
        cant_like=False
        if request.user.is_authenticated and self.post_instance.user_cant_like(request.user):
            cant_like=True
        return render(request, 'home/detail.html', {'post':self.post_instance, 'comments':comments, 'form':self.form_class, 'reply_form':self.form_class_reply, 'cant_like':cant_like})
...
class PostUpdateView(LoginRequiredMixin, View):
    ...
    def post(self,request,*args, **kwargs):
        ...
        if form.is_valid():
            ...
            new_post.save()
            messages.success(request, 'your post updated succesfully', 'success')
